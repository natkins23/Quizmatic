                ...
                <DialogHeader>
                    ...
                    <DialogDescription>
                        <div className="flex items-center gap-3 my-2">
                            <p className="flex items-center">
                                ...
                                <Link
                                    ...
                                    href="https://github.com/natkins23/quizmatic"
                                >
                                    GitHub
                                </Link>
                            </p>
                        ...
                        <p className="my-2 mt-4 ">
                            Elevate your quiz game with Quizmatic! Our
                            AI-powered platform offers adaptive, engaging
                            quizzes that challenge and entertain. No more
                            mundane trivia—experience quizzes that evolve with
                            you. Perfect for quiz enthusiasts and learners
                            alike. Dive in now!
                        </p>
                        <hr />
